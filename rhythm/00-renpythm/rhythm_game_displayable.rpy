...
define THIS_PATH = 'rhythm/00-renpythm/'
...
label rhythm_game_entry_label:
    $ with RhythmGameDisplayable(Song('Isolation', 'rhythm/audio/empty.txt', 'rhythm/audio/empty.txt')) as a:print("yay")
...
screen rhythm_game(rhythm_game_displayable):
    ...
    if rhythm_game_displayable.has_ended:
        ...
        timer 1.0 action Return(rhythm_game_displayable.score)
